...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20210213165459_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE `tbTransaction` (
        ...
        CONSTRAINT `FK_tbTransaction_tbAccount_Id1` FOREIGN KEY (`Id`) REFERENCES `tbAccount` (`Id`) ON DELETE CASCADE
    );
...
BEGIN
    ...
    VALUES ('20210213165459_InitialCreate', '3.1.11');
